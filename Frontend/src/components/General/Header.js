    ...
    return (
        ...
        <header>
            ...
            <Link to="/" className="logo">
                <img className='navBarLeftImg' src='https://th.bing.com/th/id/OIG.r6r_GO8xFY63CBugETXC?pid=ImgGn&w=1024&h=1024&rs=1'/>
                </Link>
                <SearchForm />
                <div className='header_options'>
                    ...
                    {auth ?
                        <div className="auth_options">
                            ...
                            <Link className='addPost-link' to="/addpost"><RiPencilFill /> Create Post </Link>
