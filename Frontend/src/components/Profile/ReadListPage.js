...
import ReadListPostItem from '../Post/ReadListPostItem';
        ...
        <>
            {loading ? <Loader /> :
                ...
                <div className="Inclusive-readList-page">
                    ...
                    <div className="readList-top-block">
                        ...
                        <div className='activeUser-info-wrapper'>
                            ...
                            <div>
                                ...
                                <span>-</span>
                                <span>
                                    {activeUser.readListLength} posts
                                </span>
                                <i>
                                    <AiFillLock />
                                </i>
                    ...
                    <div className="readList-post-wrapper">

                        {readList.length !== 0 ?
                            <>
                                {readList.map(post => {
                                    return (
                                        <ReadListPostItem key={post._id} post={post} editDate={editDate} />
