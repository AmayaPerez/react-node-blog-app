...
const AddComment = ({ setSidebarShowStatus, slug, getPostComments, activeUser, count }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccess('The comment has added successfully')
            setTimeout(() => {
                setSuccess('')
            }, 2700)
            ...
            {activeUser.username &&
                ...
                <form className='addComment-form' onSubmit={handleSubmit}>
                    ...
                    <div className="textarea-wrapper">
                        <div ref={textareaRef}
                            contentEditable
                            placeholder='What are you thinking?' id="comment"
                            name="content"
                            onKeyUp={(e) => {
